...
class modify():
    ...
    def modifyDesig(self, _desig, _dept, _comp):
        ...
        elif bool(re.search('WDIL', _comp)):
    ...
    def saveInfo(self):
        WebDriverWait(self.driver, 5).until(EC.element_to_be_clickable((By.XPATH, "//button[@id='ResultPanePlaceHolder_ButtonsPanel_btnCommit']")))
